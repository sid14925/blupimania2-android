...
BOOL GetResourceBase(ResType type, int num, char* text)
{
	...
	if ( type == RES_TEXT )
	{
		#if _FULL
		#if _EDU
		if ( num == RT_VERSION_ID          )  strcpy(text, "EDU 1.2 /e");
		#else
		if ( num == RT_VERSION_ID          )  strcpy(text, "1.2 /e");
		#endif
		#endif
		#if _DEMO
		if ( num == RT_VERSION_ID          )  strcpy(text, "Demo 1.2 /e");
		#endif
	...
	if ( type == RES_TEXT )
	{
		#if _FULL
		#if _EDU
		if ( num == RT_VERSION_ID          )  strcpy(text, "EDU 1.2 /d");
		#else
		if ( num == RT_VERSION_ID          )  strcpy(text, "1.2 /d");
		#endif
		#endif
		#if _DEMO
		if ( num == RT_VERSION_ID          )  strcpy(text, "Demo 1.2 /d");
		#endif
		...
		if ( num == RT_UNIVERS16           )  strcpy(text, "Labo");
		if ( num == RT_UNIVERS17           )  strcpy(text, "Pota");
		if ( num == RT_UNIVERS18           )  strcpy(text, "Sylva");
		if ( num == RT_UNIVERS19           )  strcpy(text, "Natura");
	}
	...
	if ( type == RES_EVENT )
	{
		...
		if ( num == EVENT_INTERFACE_PUZZLE )  strcpy(text, "Rätsel\\Torture progressive");
		...
		if ( num == EVENT_INTERFACE_DELETE )  strcpy(text, "Löschen\\Rätsel löschen");
		if ( num == EVENT_INTERFACE_RENAME )  strcpy(text, "Umbenennen\\Das Rätsel umbenennen");
		if ( num == EVENT_INTERFACE_EXPORT )  strcpy(text, "Exportieren\\Das Rätsel exportieren");
		if ( num == EVENT_INTERFACE_IMPORT )  strcpy(text, "Importieren\\Ein Rätsel importieren");
		if ( num == EVENT_INTERFACE_EDIT   )  strcpy(text, "Verändern\\Das Rätsel verändern");
		if ( num == EVENT_INTERFACE_OK     )  strcpy(text, "OK\\Zurück zum vorhergehenden Bildschirm");

		if ( num == EVENT_INTERFACE_EXPORTdefi )  strcpy(text, "In den Challenges (für alle Spieler)");
		if ( num == EVENT_INTERFACE_EXPORTdoc  )  strcpy(text, "Im Ordner \"Eigene Dateien\"");
		...
		if ( num == EVENT_INTERFACE_AMBIANCE    )  strcpy(text, "Wassereffekte\\Wellen und sontige Effekte auf Wasseroberflächen");
		...
		if ( num == EVENT_INTERFACE_VOLBLUPI    )  strcpy(text, "Laustärke von Blupi's Stimme\\");
	...
	if ( type == RES_OBJECT )
	{
		...
		if ( num == OBJECT_BOX8            )  strcpy(text, "Schwere Säule");
		...
		if ( num == OBJECT_GUN             )  strcpy(text, "Kistenblaster");
		if ( num == OBJECT_MINE            )  strcpy(text, "Mine");
		if ( num == OBJECT_GLASS1          )  strcpy(text, "Panzerscheibe");
		if ( num == OBJECT_GLASS2          )  strcpy(text, "Panzerscheibe");
	...
	if ( type == RES_ERR )
	{
		...
		if ( num == ERR_PUZZLE_LOGOAL   )  strcpy(text, "Es sind nicht hat genügend Ballons");
	...
	if ( type == RES_TEXT )
	{
		#if _FULL
		#if _EDU
		if ( num == RT_VERSION_ID          )  strcpy(text, "EDU 1.2 /f");
		#else
		if ( num == RT_VERSION_ID          )  strcpy(text, "1.2 /f");
		#endif
		#endif
		#if _DEMO
		if ( num == RT_VERSION_ID          )  strcpy(text, "Demo 1.2 /f");
		#endif
	...
	if ( type == RES_TEXT )
	{
		#if _FULL
		#if _EDU
		if ( num == RT_VERSION_ID          )  strcpy(text, "EDU 1.2 /i");
		#else
		if ( num == RT_VERSION_ID          )  strcpy(text, "1.2 /i");
		#endif
		#endif
		#if _DEMO
		if ( num == RT_VERSION_ID          )  strcpy(text, "Demo 1.2 /i");
		#endif
	...
	if ( type == RES_TEXT )
	{
		#if _FULL
		#if _EDU
		if ( num == RT_VERSION_ID          )  strcpy(text, "EDU 1.2 /s");
		#else
		if ( num == RT_VERSION_ID          )  strcpy(text, "1.2 /s");
		#endif
		#endif
		#if _DEMO
		if ( num == RT_VERSION_ID          )  strcpy(text, "Demo 1.2 /s");
		#endif
	...
	if ( type == RES_TEXT )
	{
		#if _FULL
		#if _EDU
		if ( num == RT_VERSION_ID          )  strcpy(text, "EDU 1.2 /p");
		#else
		if ( num == RT_VERSION_ID          )  strcpy(text, "1.2 /p");
		#endif
		#endif
		#if _DEMO
		if ( num == RT_VERSION_ID          )  strcpy(text, "Demo 1.2 /p");
		#endif
		if ( num == RT_WINDOW_MAXIMIZED    )  strcpy(text, "Maximizar");
		if ( num == RT_WINDOW_MINIMIZED    )  strcpy(text, "Minimizar");
