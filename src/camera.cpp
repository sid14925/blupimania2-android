...
// Indique la consigne de vitesse moteur avant/arri�re.
...
// Sp�cifie la direction horizontale.
...
// Sp�cifie la direction verticale.
...
// Sp�cifie l'�loignement de la cam�ra.
...
//?	}
	...
	if ( Abs(m_backMotorSpeed) <= 0.1f &&  // v�hicule arr�t� ?
		 !m_bBackLockRotate )
	{
	...
	// Fait tourner la cam�ra apr�s un certain temps d'arr�t.
