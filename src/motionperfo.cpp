...
// Sp�cifie la vitesse lin�aire dans l'action.
...
// Sp�cifie la vitesse circulaire dans l'action.
...
// Cr�e une perforatrice quelconque pos� sur le sol.
...
BOOL CMotionPerfo::EventFrame(const Event &event)
{
	...
	// Fait fumer le pot d'�chappement.
