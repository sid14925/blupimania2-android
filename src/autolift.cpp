...
BOOL CAutoLift::Start(int phase)
{
	...
	if ( m_main->RetAgain() ||  // bouton "Recommencer" utilis� ?
		 m_main->RetEdit()  ||  // �dite un puzzle ?
...
//?			m_sound->Play(SOUND_BOUMv, m_posBlupi, 1.0f, 1.0f);
			...
			if ( m_bSelect )
			{
				m_main->SelectObject(m_blupi);  // s�lectionne si n�cessaire
			}
...
// Rotation d'un point de la cam�ra.
...
// D�but du mouvement vertical de la cam�ra.
...
// D�but du mouvement horizontal de la cam�ra.
...
// Progression du mouvement sp�cial de la cam�ra.
...
// Fin du mouvement sp�cial de la cam�ra.
