...
// Cr�e un nouvel indicateur d'avance.
...
// Cr�e une nouveau lien graphique.
...
// Donne un contr�le d'apr�s son �v�nement.
...
// Donne un contr�le d'apr�s son rang.
...
// Donne le contr�le qui a le focus.
...
//?		m_engine->SetState(D3DSTATENORMAL);
	...
	else if ( icon == 12 )  // fen�tre de l'interface ?
	{
		m_engine->SetTexture("button1.tga");
//?		m_engine->SetState(D3DSTATENORMAL);
		m_engine->SetState(D3DSTATETTb);
...
//?		m_engine->SetState(D3DSTATETTw);
		...
		p1.y = 64.0f/480.0f;  // bord inf�rieur
		p2.x = 30.0f/640.0f;  // bord droite
		p2.y = 90.0f/480.0f;  // bord sup�rieur
