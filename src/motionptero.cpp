...
BOOL CMotionPtero::Create(D3DVECTOR pos, float angle, ObjectType type)
{
	...
	// Cr�e l'objet principal, inexistant !.
...
BOOL CMotionPtero::EventFrame(const Event &event)
{
	...
	m_object->SetPosition(0, pos);  // d�place tout le groupe

	// Gestion des oiseaux individuels.
	for ( i=0 ; i<m_total ; i++ )
	{
		// Progression du temps propre � chaque oiseau.
		...
		// Mouvement faible et rapide pseudo-al�atoire.
...
// Cr�e l'ombre circulaire sous un oiseau.
...
// D�place les ombres des oiseaux.
